...
async function launchBrowser() {
  ...
  // Prefer Sparticuz only in serverless; avoid temp path issues locally.
  if (serverless) {
  ...
  // Local dev: use Playwright's installed Chromium (installed via `npx playwright install chromium`)
  try {
