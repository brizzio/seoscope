...
async function launchBrowser() {
  // Prefer Playwright-installed Chromium (downloaded at build)
  ...
  const sparticuzPath = await chromiumResolved.executablePath();
  ...
  throw new Error("Chromium binary not found. Ensure Playwright browsers are installed (npm install && npx playwright install chromium).");
}
