...
async function launchBrowser() {
  ...
  if (isServerless) {
    ...
    const executablePath = await chromiumResolved.executablePath("/tmp/chromium");
  ...
  if (!localPath || !fs.existsSync(localPath)) {
    throw new Error("Playwright Chromium not found locally. Run: npm install && npx playwright install chromium");
  }
  return playwrightChromium.launch({
    headless: true,
    ignoreHTTPSErrors: true,
